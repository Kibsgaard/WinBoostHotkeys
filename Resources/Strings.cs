...
namespace WinBoostHotkeys.Resources
{
    public static class Strings
    {
        ...
        public static string LabelNetworkRulesInfo => ResourceManager.GetString("LabelNetworkRulesInfo") ?? "Rules are checked from top to bottom. The first matching rule is used.";
